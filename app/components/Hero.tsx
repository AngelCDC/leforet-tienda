          ...
          <div className="col-span-12 lg:col-span-5 space-y-8">
            ...
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-light text-slate-900 leading-tight mb-6">
                Moda
                <span className="block font-thin text-slate-600">
                  atemporal
                </span>
                con esencia
              </h1>
              ...
              <p className="text-lg text-slate-600 max-w-md leading-relaxed mb-8">
                Piezas cuidadosamente seleccionadas que definen la elegancia
                contemporánea y trascienden las tendencias.
              </p>
            </div>

            {/* Stats elegantes */}
            <div className="flex items-center gap-4 sm:gap-8 py-6 border-t border-b border-slate-200">
              <div>
                <div className="text-2xl font-light text-slate-900">200+</div>
                <div className="text-sm text-slate-500 tracking-wide">
                  Productos Curados
                </div>
              </div>
              {/* Separador más visible en móvil */}
              <div className="w-0.5 sm:w-px h-8 sm:h-12 bg-slate-300 sm:bg-slate-200"></div>
              <div>
                ...
                <div className="text-sm text-slate-500">4.8 • 1k reseñas</div>
              </div>
              <div className="w-0.5 sm:w-px h-8 sm:h-12 bg-slate-300 sm:bg-slate-200"></div>
              <div>
                <div className="text-2xl font-light text-slate-900 gap-1 mb-1">
                  1K+
                </div>
                <div className="text-sm text-slate-500 tracking-wide">
                  Ventas Realizadas
            ...
            <div className="grid grid-cols-12 gap-6 h-[600px] lg:h-[700px]">
              ...
              <div className="col-span-12 md:col-span-8 group">
                <div className="relative h-full overflow-hidden bg-slate-100">
                  {/* Badge premium - responsive */}
                  <div className="absolute top-3 sm:top-6 left-3 sm:left-6 z-20">
                    <div className="bg-slate-900 text-white px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-light tracking-[0.05em] sm:tracking-[0.1em]">
                      <span className="hidden sm:inline">
                        NUEVA COLECCIÓN SS25
                      </span>
                      <span className="sm:hidden">NUEVA COLECCIÓN SS25</span>
                    </div>
                  </div>

                  {/* Badge featured - responsive */}
                  <div className="absolute top-3 sm:top-6 right-3 sm:right-6 z-20">
                    <div className="bg-white/90 backdrop-blur-sm text-slate-900 px-2 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-light tracking-[0.05em] sm:tracking-[0.1em] border border-slate-200">
                      FEATURED
                    </div>
                  </div>
                  ...
                  {/* Overlay con controles elegantes - responsive 
                  <div className="absolute inset-0 bg-slate-900/0 group-hover:bg-slate-900/20 transition-all duration-500">
                    <div className="absolute bottom-3 sm:bottom-6 left-3 sm:left-6 right-3 sm:right-6 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0">
                      <div className="flex gap-2 sm:gap-3">
                        <button className="w-10 h-10 sm:w-12 sm:h-12 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white transition-all hover:scale-110 shadow-lg">
                      ...
                      <Link href="/productos/featured">
                        <button className="bg-slate-900 text-white px-3 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm font-light tracking-[0.05em] sm:tracking-[0.1em] hover:bg-slate-800 transition-all">
                          <span className="hidden sm:inline">
                            VIEW COLLECTION
                          </span>
