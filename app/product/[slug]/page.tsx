                ...
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <div className="md:py-8">
                        ...
                        <div className="flex gap-2.5 ">
                            ...
                            key={data._id}
                            />
                            <Link href={`https://wa.me/584120828474?text=*Hola,%20me%20interesa%20el%20siguiente%20articulo*.%0a*Producto:*%20${data.name}%0a*Categoria:*%20${data.categoryName}%0a*Precio:*%20${data.price}$`}><Button>Comprar Ahora</Button></Link>
                        </div>
